...
function quotegenrator (){
    ...
    setTimeout(() => {
        var numberlist = Math.floor(Math.random()* localQuotes.length);
    
        
        document.getElementById("quote").innerHTML = localQuotes[numberlist].text;
    
    if (localQuotes[numberlist].author === null) {
            document.getElementById("author").innerHTML = "Unknown";
            } else {
                document.getElementById("author").innerHTML = localQuotes[numberlist].author;
            }
...
document.getElementById("new-quote").addEventListener("click",quotegenrator);
